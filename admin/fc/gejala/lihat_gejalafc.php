...
echo"<h2><a  href='?page=gejala_penyakitfc'><i class='fa fa-list-alt'></i> Gejala Penyakit</a></h2><hr>";
...
<div class="tab-content" id="myTabContent">
  <div class="tab-pane fade" id="gejala" role="tabpanel" aria-labelledby="gejala-tab">
	<?php 
		require_once "../fc/gejala/lihat_gejala_penyakitfc.php";
	?>
  </div>
  <div class="tab-pane fade" id="atribut" role="tabpanel" aria-labelledby="atribut-tab">
	  <?php 
		require_once "../fc/gejala/lihat_atribut_penyakitfc.php";
	?>
  </div>
</div>
